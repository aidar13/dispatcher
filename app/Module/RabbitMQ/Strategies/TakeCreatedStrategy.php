...
class TakeCreatedStrategy implements RabbitMQRequestStrategy
{
    ...
    {
        return RabbitMQRequest::TYPE_ORDER_TAKE_CREATED === $channel;
    }
    ...
    public function execute(RabbitMQRequest $request): void
    {
        ...
        try {
            $this->dispatcher->dispatchNow(new CreateOrderTakeCommand(OrderTakeDTO::fromEvent($data)));
            ...
            Log::info('Не удалось создать забор в диспетчерской: ', [
