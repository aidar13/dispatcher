...
class ReceiverUpdatedStrategy implements RabbitMQRequestStrategy
{
    ...
    {
        return RabbitMQRequest::TYPE_RECEIVER_UPDATED === $channel;
    }
    ...
    public function execute(RabbitMQRequest $request): void
    {
        ...
        try {
            $this->dispatcher->dispatchNow(new UpdateReceiverCommand(ReceiverDTO::fromEvent($data->DTO)));
            ...
            Log::info('Не удалось редактировать получателя в диспетчерской: ', [
