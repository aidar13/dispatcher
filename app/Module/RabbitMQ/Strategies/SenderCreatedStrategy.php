...
class SenderCreatedStrategy implements RabbitMQRequestStrategy
{
    ...
    {
        return RabbitMQRequest::TYPE_SENDER_CREATED === $channel;
    }
    ...
    public function execute(RabbitMQRequest $request): void
    {
        ...
        try {
            $this->dispatcher->dispatchNow(new CreateSenderCommand(SenderDTO::fromEvent($data->DTO)));
            ...
            Log::info('Не удалось создать отправителя в диспетчерской: ', [
                'senderId' => $data->DTO,
