...
class DeliveryCreatedStrategy implements RabbitMQRequestStrategy
{
    ...
    {
        return RabbitMQRequest::TYPE_DELIVERY_CREATED === $channel;
    }
    ...
    public function execute(RabbitMQRequest $request): void
    {
        ...
        try {
            $this->dispatcher->dispatchNow(new CreateDeliveryCommand(DeliveryDTO::fromEvent($data)));
            ...
            Log::info('Не удалось создать доставку в диспетчерской: ', [
                'takeId'  => $data->DTO?->id,
