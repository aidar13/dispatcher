 ...
 *     @OA\Property(property="dispatcherSectorName", type="string", example="Алматы"),
 ...
 */
final class SectorShowResource extends JsonResource
{
    public function toArray($request): array
    {
        return [
            ...
            'dispatcherSectorName' => $this->resource->dispatcherSector ? $this->resource->dispatcherSector->name : null,
