...
/**
 * @OA\Schema(
 *     required={"name", "coordinates", "color", "dispatcherSectorId"},
 *
...
final class CreateSectorRequest extends FormRequest
{
    ...
    public function getDTO(): CreateSectorDTO
    {
        return CreateSectorDTO::fromRequest($this);
    }
}
