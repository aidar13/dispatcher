 ...
 * )
 */
final class CreateDispatcherSectorRequest extends FormRequest
{
    ...
    public function getDTO(): CreateDispatcherSectorDTO
    {
        return CreateDispatcherSectorDTO::fromRequest($this);
    }
}
